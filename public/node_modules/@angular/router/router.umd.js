...
(function (global, factory) {
    ...
    /**
     * Defines index for a given component.
     *
    ...
    */
    ...
    function _match(metadata, url) {
        ...
        throw new _angular_core.BaseException("Cannot match any index. Current segment: '" + url.value + "'. Available index: [" + availableRoutes + "].");
    }
    ...
    var RouterLink = (function () {
        function RouterLink(_routeSegment, _router) {
            ...
            this._commands = [];
            this.isActive = false;
            // because auxiliary links take existing primary and auxiliary index into account,
            // we need to update the link whenever params or other index change.
            this._subscription =
