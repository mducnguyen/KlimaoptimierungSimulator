...
/**
 * Return a `Collection` of all index defined.
 *
 * @return {Collection}
 * @api public
 */
...
/**
 * Return index with route paths matching `path`.
 *
 * @param {String} method
 * @param {String} path
 * @return {Collection}
...
/**
 * Return index with regexps that match the given `url`.
 *
 * @param {String} method
 * @param {String} url
 * @return {Collection}
...
/**
 * Find index based on the return value of `fn`
...
Router.prototype._route = function(method, path, callbacks){
  ...
  var route = new Route(method, path, callbacks, {
      sensitive: app.enabled('case sensitive index')
