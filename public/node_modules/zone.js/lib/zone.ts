 ...
 * 2. Wrap callbacks for error-handling and zone api-usage across async operations.
 ...
 * achieving the request. (Useful for unit testing, or api-usage of requests). In some instances
 ...
 * to handle error handling, while child zones may chose to do user action api-usage.
 *
 *
 * ## Root Zone
 *
